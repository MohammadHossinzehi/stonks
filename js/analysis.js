function updateSummary(data){
    ...
    const averagePrice = priceCount > 0 ? (totalPrice / priceCount).toFixed(2) : 'N/A';
    ...
    document.getElementById('keyPatterns').textContent = `Most traded stock: ${mostTradedTicker} (${maxTrades} trades), Buys: ${typeCounts.buy}, Sells: ${typeCounts.sell}`;
}
...
function updateHighVolumeTrades(data) {
    const highVolumeThresholds = ["$50K-100K","100K-250K","250K-500K","500K-1M","1M-2.5M","2.5M-5M","5M-10M","10M+"];
